  ...
  class ListsApi
    ...
    def get_user_list_memberships_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.get_user_list_memberships ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ListsApi.get_user_list_memberships"
      end
    ...
    def list_add_member_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.list_add_member ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ListsApi.list_add_member"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling ListsApi.list_add_member, must conform to the pattern #{pattern}."
      end
    ...
    def list_id_create_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.list_id_create ...'
      end
      # resource path
    ...
    def list_id_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.list_id_delete ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ListsApi.list_id_delete"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling ListsApi.list_id_delete, must conform to the pattern #{pattern}."
      end
    ...
    def list_id_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.list_id_get ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ListsApi.list_id_get"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling ListsApi.list_id_get, must conform to the pattern #{pattern}."
      end
    ...
    def list_id_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.list_id_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ListsApi.list_id_update"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling ListsApi.list_id_update, must conform to the pattern #{pattern}."
      end
    ...
    def list_remove_member_with_http_info(id, user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.list_remove_member ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ListsApi.list_remove_member"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling ListsApi.list_remove_member, must conform to the pattern #{pattern}."
      end

      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling ListsApi.list_remove_member"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && user_id !~ pattern
        fail ArgumentError, "invalid value for 'user_id' when calling ListsApi.list_remove_member, must conform to the pattern #{pattern}."
      end

      # resource path
      local_var_path = '/2/lists/{id}/members/{user_id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'user_id' + '}', CGI.escape(user_id.to_s))
    ...
    def list_user_follow_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.list_user_follow ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ListsApi.list_user_follow"
      end
      # resource path
    ...
    def list_user_owned_lists_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.list_user_owned_lists ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ListsApi.list_user_owned_lists"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
    ...
    def list_user_pin_with_http_info(id, list_pinned_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.list_user_pin ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ListsApi.list_user_pin"
      end
      # verify the required parameter 'list_pinned_request' is set
      if @api_client.config.client_side_validation && list_pinned_request.nil?
        fail ArgumentError, "Missing the required parameter 'list_pinned_request' when calling ListsApi.list_user_pin"
      end
      # resource path
    ...
    def list_user_pinned_lists_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.list_user_pinned_lists ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
    ...
    def list_user_unfollow_with_http_info(id, list_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.list_user_unfollow ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ListsApi.list_user_unfollow"
      end
      # verify the required parameter 'list_id' is set
      if @api_client.config.client_side_validation && list_id.nil?
        fail ArgumentError, "Missing the required parameter 'list_id' when calling ListsApi.list_user_unfollow"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && list_id !~ pattern
        fail ArgumentError, "invalid value for 'list_id' when calling ListsApi.list_user_unfollow, must conform to the pattern #{pattern}."
      end

      # resource path
      local_var_path = '/2/users/{id}/followed_lists/{list_id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'list_id' + '}', CGI.escape(list_id.to_s))
    ...
    def list_user_unpin_with_http_info(id, list_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.list_user_unpin ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ListsApi.list_user_unpin"
      end
      # verify the required parameter 'list_id' is set
      if @api_client.config.client_side_validation && list_id.nil?
        fail ArgumentError, "Missing the required parameter 'list_id' when calling ListsApi.list_user_unpin"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && list_id !~ pattern
        fail ArgumentError, "invalid value for 'list_id' when calling ListsApi.list_user_unpin, must conform to the pattern #{pattern}."
      end

      # resource path
      local_var_path = '/2/users/{id}/pinned_lists/{list_id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'list_id' + '}', CGI.escape(list_id.to_s))
    ...
    def user_followed_lists_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ListsApi.user_followed_lists ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ListsApi.user_followed_lists"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
