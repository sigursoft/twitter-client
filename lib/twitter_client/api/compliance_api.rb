  ...
  class ComplianceApi
    ...
    def create_batch_compliance_job_with_http_info(create_compliance_job_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ComplianceApi.create_batch_compliance_job ...'
      end
      ...
      if @api_client.config.client_side_validation && create_compliance_job_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_compliance_job_request' when calling ComplianceApi.create_batch_compliance_job"
      end
      # resource path
    ...
    def get_batch_compliance_job_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ComplianceApi.get_batch_compliance_job ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ComplianceApi.get_batch_compliance_job"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling ComplianceApi.get_batch_compliance_job, must conform to the pattern #{pattern}."
      end
    ...
    def get_tweets_compliance_stream_with_http_info(partition, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ComplianceApi.get_tweets_compliance_stream ...'
      end
      # verify the required parameter 'partition' is set
      if @api_client.config.client_side_validation && partition.nil?
        fail ArgumentError, "Missing the required parameter 'partition' when calling ComplianceApi.get_tweets_compliance_stream"
      end
      if @api_client.config.client_side_validation && partition > 4
        fail ArgumentError, 'invalid value for "partition" when calling ComplianceApi.get_tweets_compliance_stream, must be smaller than or equal to 4.'
      end
    ...
    def get_users_compliance_stream_with_http_info(partition, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ComplianceApi.get_users_compliance_stream ...'
      end
      # verify the required parameter 'partition' is set
      if @api_client.config.client_side_validation && partition.nil?
        fail ArgumentError, "Missing the required parameter 'partition' when calling ComplianceApi.get_users_compliance_stream"
      end
      if @api_client.config.client_side_validation && partition > 4
        fail ArgumentError, 'invalid value for "partition" when calling ComplianceApi.get_users_compliance_stream, must be smaller than or equal to 4.'
      end
    ...
    def list_batch_compliance_jobs_with_http_info(type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ComplianceApi.list_batch_compliance_jobs ...'
      end
      # verify the required parameter 'type' is set
      if @api_client.config.client_side_validation && type.nil?
        fail ArgumentError, "Missing the required parameter 'type' when calling ComplianceApi.list_batch_compliance_jobs"
      end
      # verify enum value
      allowable_values = ["tweets", "users"]
