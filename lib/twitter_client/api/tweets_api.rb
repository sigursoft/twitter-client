  ...
  class TweetsApi
    ...
    def add_or_delete_rules_with_http_info(add_or_delete_rules_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.add_or_delete_rules ...'
      end
      ...
      if @api_client.config.client_side_validation && add_or_delete_rules_request.nil?
        fail ArgumentError, "Missing the required parameter 'add_or_delete_rules_request' when calling TweetsApi.add_or_delete_rules"
      end
      # resource path
    ...
    def create_tweet_with_http_info(tweet_create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.create_tweet ...'
      end
      # verify the required parameter 'tweet_create_request' is set
      if @api_client.config.client_side_validation && tweet_create_request.nil?
        fail ArgumentError, "Missing the required parameter 'tweet_create_request' when calling TweetsApi.create_tweet"
      end
      # resource path
    ...
    def delete_tweet_by_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.delete_tweet_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.delete_tweet_by_id"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling TweetsApi.delete_tweet_by_id, must conform to the pattern #{pattern}."
      end
    ...
    def find_tweet_by_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.find_tweet_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.find_tweet_by_id"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling TweetsApi.find_tweet_by_id, must conform to the pattern #{pattern}."
      end
    ...
    def find_tweets_by_id_with_http_info(ids, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.find_tweets_by_id ...'
      end
      # verify the required parameter 'ids' is set
      if @api_client.config.client_side_validation && ids.nil?
        fail ArgumentError, "Missing the required parameter 'ids' when calling TweetsApi.find_tweets_by_id"
      end
      if @api_client.config.client_side_validation && ids.length > 100
        fail ArgumentError, 'invalid value for "ids" when calling TweetsApi.find_tweets_by_id, number of items must be less than or equal to 100.'
      end

      if @api_client.config.client_side_validation && ids.length < 1
        fail ArgumentError, 'invalid value for "ids" when calling TweetsApi.find_tweets_by_id, number of items must be greater than or equal to 1.'
      end
    ...
    def find_tweets_that_quote_a_tweet_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.find_tweets_that_quote_a_tweet ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.find_tweets_that_quote_a_tweet"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
    ...
    def get_tweets_firehose_stream_with_http_info(partition, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.get_tweets_firehose_stream ...'
      end
      # verify the required parameter 'partition' is set
      if @api_client.config.client_side_validation && partition.nil?
        fail ArgumentError, "Missing the required parameter 'partition' when calling TweetsApi.get_tweets_firehose_stream"
      end
      if @api_client.config.client_side_validation && partition > 20
        fail ArgumentError, 'invalid value for "partition" when calling TweetsApi.get_tweets_firehose_stream, must be smaller than or equal to 20.'
      end
    ...
    def get_tweets_sample10_stream_with_http_info(partition, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.get_tweets_sample10_stream ...'
      end
      # verify the required parameter 'partition' is set
      if @api_client.config.client_side_validation && partition.nil?
        fail ArgumentError, "Missing the required parameter 'partition' when calling TweetsApi.get_tweets_sample10_stream"
      end
      if @api_client.config.client_side_validation && partition > 2
        fail ArgumentError, 'invalid value for "partition" when calling TweetsApi.get_tweets_sample10_stream, must be smaller than or equal to 2.'
      end
    ...
    def hide_reply_by_id_with_http_info(tweet_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.hide_reply_by_id ...'
      end
      # verify the required parameter 'tweet_id' is set
      if @api_client.config.client_side_validation && tweet_id.nil?
        fail ArgumentError, "Missing the required parameter 'tweet_id' when calling TweetsApi.hide_reply_by_id"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && tweet_id !~ pattern
        fail ArgumentError, "invalid value for 'tweet_id' when calling TweetsApi.hide_reply_by_id, must conform to the pattern #{pattern}."
      end
    ...
    def lists_id_tweets_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.lists_id_tweets ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.lists_id_tweets"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
    ...
    def space_buyers_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.space_buyers ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.space_buyers"
      end
    ...
    def space_tweets_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.space_tweets ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.space_tweets"
      end
      pattern = Regexp.new(/^[a-zA-Z0-9]{1,13}$/)
      if @api_client.config.client_side_validation && id !~ pattern
    ...
    def tweet_counts_full_archive_search_with_http_info(query, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.tweet_counts_full_archive_search ...'
      end
      # verify the required parameter 'query' is set
      if @api_client.config.client_side_validation && query.nil?
        fail ArgumentError, "Missing the required parameter 'query' when calling TweetsApi.tweet_counts_full_archive_search"
      end
      if @api_client.config.client_side_validation && query.to_s.length > 4096
        fail ArgumentError, 'invalid value for "query" when calling TweetsApi.tweet_counts_full_archive_search, the character length must be smaller than or equal to 4096.'
      end

      if @api_client.config.client_side_validation && query.to_s.length < 1
        fail ArgumentError, 'invalid value for "query" when calling TweetsApi.tweet_counts_full_archive_search, the character length must be great than or equal to 1.'
      end
    ...
    def tweet_counts_recent_search_with_http_info(query, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.tweet_counts_recent_search ...'
      end
      # verify the required parameter 'query' is set
      if @api_client.config.client_side_validation && query.nil?
        fail ArgumentError, "Missing the required parameter 'query' when calling TweetsApi.tweet_counts_recent_search"
      end
      if @api_client.config.client_side_validation && query.to_s.length > 4096
        fail ArgumentError, 'invalid value for "query" when calling TweetsApi.tweet_counts_recent_search, the character length must be smaller than or equal to 4096.'
      end

      if @api_client.config.client_side_validation && query.to_s.length < 1
        fail ArgumentError, 'invalid value for "query" when calling TweetsApi.tweet_counts_recent_search, the character length must be great than or equal to 1.'
      end
    ...
    def tweets_fullarchive_search_with_http_info(query, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.tweets_fullarchive_search ...'
      end
      # verify the required parameter 'query' is set
      if @api_client.config.client_side_validation && query.nil?
        fail ArgumentError, "Missing the required parameter 'query' when calling TweetsApi.tweets_fullarchive_search"
      end
      if @api_client.config.client_side_validation && query.to_s.length > 4096
        fail ArgumentError, 'invalid value for "query" when calling TweetsApi.tweets_fullarchive_search, the character length must be smaller than or equal to 4096.'
      end

      if @api_client.config.client_side_validation && query.to_s.length < 1
        fail ArgumentError, 'invalid value for "query" when calling TweetsApi.tweets_fullarchive_search, the character length must be great than or equal to 1.'
      end
    ...
    def tweets_recent_search_with_http_info(query, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.tweets_recent_search ...'
      end
      # verify the required parameter 'query' is set
      if @api_client.config.client_side_validation && query.nil?
        fail ArgumentError, "Missing the required parameter 'query' when calling TweetsApi.tweets_recent_search"
      end
      if @api_client.config.client_side_validation && query.to_s.length > 4096
        fail ArgumentError, 'invalid value for "query" when calling TweetsApi.tweets_recent_search, the character length must be smaller than or equal to 4096.'
      end

      if @api_client.config.client_side_validation && query.to_s.length < 1
        fail ArgumentError, 'invalid value for "query" when calling TweetsApi.tweets_recent_search, the character length must be great than or equal to 1.'
      end
    ...
    def users_id_like_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.users_id_like ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.users_id_like"
      end
      # resource path
    ...
    def users_id_liked_tweets_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.users_id_liked_tweets ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.users_id_liked_tweets"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
    ...
    def users_id_mentions_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.users_id_mentions ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.users_id_mentions"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling TweetsApi.users_id_mentions, must conform to the pattern #{pattern}."
      end
    ...
    def users_id_retweets_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.users_id_retweets ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.users_id_retweets"
      end
      # resource path
    ...
    def users_id_timeline_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.users_id_timeline ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
    ...
    def users_id_tweets_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.users_id_tweets ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.users_id_tweets"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling TweetsApi.users_id_tweets, must conform to the pattern #{pattern}."
      end
    ...
    def users_id_unlike_with_http_info(id, tweet_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.users_id_unlike ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.users_id_unlike"
      end
      # verify the required parameter 'tweet_id' is set
      if @api_client.config.client_side_validation && tweet_id.nil?
        fail ArgumentError, "Missing the required parameter 'tweet_id' when calling TweetsApi.users_id_unlike"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && tweet_id !~ pattern
        fail ArgumentError, "invalid value for 'tweet_id' when calling TweetsApi.users_id_unlike, must conform to the pattern #{pattern}."
      end

      # resource path
      local_var_path = '/2/users/{id}/likes/{tweet_id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'tweet_id' + '}', CGI.escape(tweet_id.to_s))
    ...
    def users_id_unretweets_with_http_info(id, source_tweet_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TweetsApi.users_id_unretweets ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TweetsApi.users_id_unretweets"
      end
      # verify the required parameter 'source_tweet_id' is set
      if @api_client.config.client_side_validation && source_tweet_id.nil?
        fail ArgumentError, "Missing the required parameter 'source_tweet_id' when calling TweetsApi.users_id_unretweets"
      end
      pattern = Regexp.new(/^[0-9]{1,19}$/)
      if @api_client.config.client_side_validation && source_tweet_id !~ pattern
        fail ArgumentError, "invalid value for 'source_tweet_id' when calling TweetsApi.users_id_unretweets, must conform to the pattern #{pattern}."
      end

      # resource path
      local_var_path = '/2/users/{id}/retweets/{source_tweet_id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'source_tweet_id' + '}', CGI.escape(source_tweet_id.to_s))
