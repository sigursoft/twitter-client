...
module TwitterClient
  class TweetNotice
    ...
    attr_accessor :extended_details_url
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TwitterClient::TweetNotice` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TwitterClient::TweetNotice`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          extended_details_url == o.extended_details_url &&
          label_title == o.label_title &&
          tweet == o.tweet
    end
    ...
    def hash
      [application, details, event_at, event_type, extended_details_url, label_title, tweet].hash
    end
