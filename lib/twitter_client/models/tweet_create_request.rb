  ...
  class TweetCreateRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TwitterClient::TweetCreateRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TwitterClient::TweetCreateRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      reply_settings_validator = EnumAttributeValidator.new('String', ["following", "mentionedUsers"])
    ...
    def reply_settings=(reply_settings)
      validator = EnumAttributeValidator.new('String', ["following", "mentionedUsers"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          card_uri == o.card_uri &&
          direct_message_deep_link == o.direct_message_deep_link &&
          for_super_followers_only == o.for_super_followers_only &&
          geo == o.geo &&
          media == o.media &&
          nullcast == o.nullcast &&
          poll == o.poll &&
    ...
    def hash
      [card_uri, direct_message_deep_link, for_super_followers_only, geo, media, nullcast, poll, quote_tweet_id, reply, reply_settings, text].hash
    end
