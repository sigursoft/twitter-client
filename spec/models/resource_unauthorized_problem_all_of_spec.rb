...
# Unit tests for TwitterClient::ResourceUnauthorizedProblemAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TwitterClient::ResourceUnauthorizedProblemAllOf do
  let(:instance) { TwitterClient::ResourceUnauthorizedProblemAllOf.new }
  ...
  describe 'test an instance of ResourceUnauthorizedProblemAllOf' do
    it 'should create an instance of ResourceUnauthorizedProblemAllOf' do
      expect(instance).to be_instance_of(TwitterClient::ResourceUnauthorizedProblemAllOf)
    end
  end
