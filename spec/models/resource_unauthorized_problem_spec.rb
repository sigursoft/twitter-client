...
# Unit tests for TwitterClient::ResourceUnauthorizedProblem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TwitterClient::ResourceUnauthorizedProblem do
  let(:instance) { TwitterClient::ResourceUnauthorizedProblem.new }

  describe 'test an instance of ResourceUnauthorizedProblem' do
    it 'should create an instance of ResourceUnauthorizedProblem' do
      expect(instance).to be_instance_of(TwitterClient::ResourceUnauthorizedProblem)
    end
  end
