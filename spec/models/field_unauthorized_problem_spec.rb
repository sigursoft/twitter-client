...
# Unit tests for TwitterClient::FieldUnauthorizedProblem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TwitterClient::FieldUnauthorizedProblem do
  let(:instance) { TwitterClient::FieldUnauthorizedProblem.new }

  describe 'test an instance of FieldUnauthorizedProblem' do
    it 'should create an instance of FieldUnauthorizedProblem' do
      expect(instance).to be_instance_of(TwitterClient::FieldUnauthorizedProblem)
    end
  end
