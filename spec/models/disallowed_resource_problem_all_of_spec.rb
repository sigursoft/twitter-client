...
# Unit tests for TwitterClient::DisallowedResourceProblemAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TwitterClient::DisallowedResourceProblemAllOf do
  let(:instance) { TwitterClient::DisallowedResourceProblemAllOf.new }
  ...
  describe 'test an instance of DisallowedResourceProblemAllOf' do
    it 'should create an instance of DisallowedResourceProblemAllOf' do
      expect(instance).to be_instance_of(TwitterClient::DisallowedResourceProblemAllOf)
    end
  end
